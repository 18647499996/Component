...
public class ADSwipeFlingAdapterView extends BaseFlingAdapterView {
    ...
    public ADSwipeFlingAdapterView(Context context) {
        this(context, null);
    }

    public ADSwipeFlingAdapterView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ADSwipeFlingAdapterView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ADSwipeFlingAdapterView, defStyle, 0);
        MAX_VISIBLE = a.getInt(R.styleable.ADSwipeFlingAdapterView_liu_max_visible, MAX_VISIBLE);
        MIN_ADAPTER_STACK = a.getInt(R.styleable.ADSwipeFlingAdapterView_liu_min_adapter_stack, MIN_ADAPTER_STACK);
        ROTATION_DEGREES = a.getFloat(R.styleable.ADSwipeFlingAdapterView_liu_rotation_degrees, ROTATION_DEGREES);
        yOffsetStep = a.getDimensionPixelOffset(R.styleable.ADSwipeFlingAdapterView_liu_y_offset_step, 0);
        a.recycle();
